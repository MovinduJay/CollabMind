...
Send-WebSocketJson $socket @{
    ...
    payload = @{
        ...
        content = "@github summarize octocat/Hello-World"
    }
}
...
if ($aiMessageCreated.payload.message.content -notmatch "MCP tool bridge: github\.repo_summary") {
    throw "Expected AI message to include GitHub MCP bridge result"
}
...
Write-Host ""
Write-Host "E2E realtime GitHub MCP test passed."
